        ...
        do {
            ...
            return results.compactMap { entity in
                guard let id = entity.id,
                      ...
                      let planId = entity.planId,
                      let checkInDate = entity.checkInDate,
                      let reviewStatusString = entity.reviewStatus,
                      let reviewStatus = ReviewStatus(rawValue: reviewStatusString) else {
                    return nil
                }
