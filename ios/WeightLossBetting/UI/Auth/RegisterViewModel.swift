...
class RegisterViewModel {
    ...
    func register(email: String, password: String, nickname: String, completion: @escaping (Result<User, Error>) -> Void) {
        // Validate input
        ...
        authRepository.register(email: email, password: password, nickname: nickname) { result in
            switch result {
